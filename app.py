...
from app_pages.page_house_sales_price_study import page_house_sales_price_study_body
...
app.add_page("Customer Base Churn Study", page_house_sales_price_study_body)
